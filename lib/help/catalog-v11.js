export const v11HelpProcedures = [
  ...
  },
  {
    ...
    roles: ["user"], contexts: ["portal", "ticket"], prerequisites: ["COM-CNX-001"], tags: ["portail", "client", "ticket", "document"],
    steps: [
  ...
  },
  {
    ...
    roles: ["user", "admin"], contexts: ["troubleshooting", "portal"], prerequisites: ["USR-V11-PORTAL-001"], tags: ["dépannage", "portail", "idor", "document"],
    steps: [
