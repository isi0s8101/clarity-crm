...
> = {
  admin: [
    ...
    ["audit", "read", "tenant"],
    ["audit", "export", "tenant"],
    ...["saved_view", "dashboard"].flatMap((object) => [
      [object, "read", "tenant"] as [string, PermissionAction, PermissionScope],
      [object, "create", "tenant"] as [string, PermissionAction, PermissionScope],
      [object, "update", "tenant"] as [string, PermissionAction, PermissionScope],
      [object, "delete", "tenant"] as [string, PermissionAction, PermissionScope],
    ]),
    ["user_preference", "read", "personal"],
    ["user_preference", "update", "personal"],
    ["favorite", "read", "personal"],
    ["favorite", "create", "personal"],
    ["favorite", "delete", "personal"],
  ],
  user: [
    ...
    ["template", "read", "tenant"],
    ["audit", "read", "personal"],
    ["saved_view", "read", "team"],
    ["saved_view", "create", "personal"],
    ["saved_view", "update", "personal"],
    ["saved_view", "delete", "personal"],
    ["dashboard", "read", "team"],
    ["dashboard", "create", "personal"],
    ["dashboard", "update", "personal"],
    ["dashboard", "delete", "personal"],
    ["user_preference", "read", "personal"],
    ["user_preference", "update", "personal"],
    ["favorite", "read", "personal"],
    ["favorite", "create", "personal"],
