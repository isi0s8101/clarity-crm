...
| SEC-01 | v0.1 | Same-origin des mutations à cookie | n/a | `assertSameOriginMutation` sur routes métier | n/a | n/a | n/a | n/a | lint, typecheck, tests source | IMPLÉMENTÉ_NON_TESTÉ |
