...
Les documents binaires POSIX, les notifications internes, l'import CSV contrôlé (aperçu avant écriture) et les exports CSV/XLSX sont désormais implémentés sur les API et la console. Ils attendent encore leur exécution de recette PostgreSQL CI avant d'être déclarés validés. Le dashboard actuel est calculé depuis les données CRM accessibles, mais attend encore une recette PostgreSQL complète.
